...
-- ----------------------------
BEGIN;
INSERT INTO `xm_pay_channel` (`id`, `name`, `mode`, `method_id`, `driver_key`, `ratio`, `app_type`, `day_limit`, `day_status`, `pay_min`, `pay_max`, `app_wxmp`, `app_wxa`, `cost_ratio`, `secret_config`, `status`, `created_at`, `updated_at`, `sort_order`) VALUES (1, '平台通道1', 0, 7, 'monipay', 90.00, '1,2,3', 500000.00, 0, 0.01, 200000.00, 0, 0, 0.00, '', 1, 0, 1732763390, 500);
INSERT INTO `xm_pay_channel` (`id`, `name`, `mode`, `method_id`, `driver_key`, `ratio`, `app_type`, `day_limit`, `day_status`, `pay_min`, `pay_max`, `app_wxmp`, `app_wxa`, `cost_ratio`, `secret_config`, `status`, `created_at`, `updated_at`, `sort_order`) VALUES (2, '商户A通道', 1, 7, 'monipay', 0.00, '1,3,5', 0.00, 0, 0.00, 0.00, 0, 0, 0.00, '', 1, 0, 0, 500);
INSERT INTO `xm_pay_channel` (`id`, `name`, `mode`, `method_id`, `driver_key`, `ratio`, `app_type`, `day_limit`, `day_status`, `pay_min`, `pay_max`, `app_wxmp`, `app_wxa`, `cost_ratio`, `secret_config`, `status`, `created_at`, `updated_at`, `sort_order`) VALUES (3, '平台测试通道2', 0, 1, 'monipay2', 90.00, '', 200000.00, 0, 0.00, 0.00, 0, 0, 3.00, '', 1, 1732782876, 1732788460, 500);
COMMIT;
