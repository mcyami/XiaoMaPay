	...
	function(exports) {
		...
		var pearAdmin = new function() {
			...
			this.themeRender = function(option) {
				...
				var menu = localStorage.getItem("m-theme-menu");
				if (menu === null) {
				...
				var header = localStorage.getItem("m-theme-header");
				if (header === null) {
				...
				var banner = localStorage.getItem("m-theme-banner");
				if (banner === null) {
				...
				var autoHead = localStorage.getItem("m-auto-head");
				if (autoHead === null) {
				...
				var muiltTab = localStorage.getItem("m-muilt-tab");
				if (muiltTab === null) {
				...
				var control = localStorage.getItem("m-control");
				if (control === null) {
				...
				var footer = localStorage.getItem("m-footer");
				if( footer === null) {
				...
				localStorage.setItem("m-muilt-tab", muiltTab);
				localStorage.setItem("m-theme-banner", banner);
				localStorage.setItem("m-theme-menu", menu);
				localStorage.setItem("m-theme-header", header);
				localStorage.setItem("m-auto-head", autoHead);
				localStorage.setItem("m-control", control);
				localStorage.setItem("m-footer", footer);
				this.menuSkin(menu);
		...
		function isControl(option) {
			if (option.theme.allowCustom) {
				if (localStorage.getItem("m-control") != null) {
					return localStorage.getItem("m-control")
				} else {
		...
		function isAutoHead(option) {
			if (option.theme.allowCustom) {
				if (localStorage.getItem("m-auto-head") != null) {
					return localStorage.getItem("m-auto-head");
				} else {
		...
		function isMuiltTab(option) {
			if (option.theme.allowCustom) {
				if (localStorage.getItem("m-muilt-tab") != null) {
					return localStorage.getItem("m-muilt-tab")
				} else {
